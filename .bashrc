...
clipfile() { file=$1; if [ ! -f "$file" ]; then echo "$file: file not found"; return; fi; cat "$file"|xclip -i -selection clipboard; echo "$file: contents copied to clipboard"; }
#alias firefox='/opt/firefox/.firefox-bin'
export PATH=/home/berk/.meteor:$PATH
